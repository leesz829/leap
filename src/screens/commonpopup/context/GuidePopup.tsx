                                  ...
                                  <SpaceView viewStyle={commonStyle.paddingHorizontal15}>
                                    ...
                                    {index == 1 &&
                                      <>
                                        ...
                                        <Text style={[_styles.liveTxt03, {color: '#697AE6'}]}>TIP 리프의 다양한 보상도 인벤토리에서 확인 가능!</Text>
                                      </>
                                    }
                      ...
                      <LinearGradient 
                        ...
                        <SpaceView viewStyle={{padding: 15}}>
                          <SpaceView viewStyle={[layoutStyle.alignCenter, {padding: 20,backgroundColor: '#FFF', borderRadius: 10}]} mt={30} mb={30}>
                            ...
                            <CommonText fontWeight={'400'} color='#D5CD9E' textStyle={{fontSize: 13, marginTop: 5}}>리프님과 매칭 성공!</CommonText>
