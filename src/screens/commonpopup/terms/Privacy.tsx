...
interface Props {
	modalRef: undefined;
	callBackFunc: (isAgree:boolean) => void;
}

const { width, height } = Dimensions.get('window');

export default function Privacy({ modalRef, callBackFunc }: Props) {

	const modalClose = (isAgree:boolean) => {
		modalRef?.current?.close();
		callBackFunc(isAgree);
	}; 
