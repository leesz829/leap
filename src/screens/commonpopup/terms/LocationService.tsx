...
export default function LocationService({ modalRef, callBackFunc }: Props) {
			...
			<View style={[modalStyle.modalBody, layoutStyle.flex1, {backgroundColor: '#1B1633'}]}>
				<SpaceView mb={24} viewStyle={{ width: width - 32 }}>
					<Text style={styles.fontStyle('B', 11, '#fff')}>
						...
						{'\n'}
						제 1 조 (목적){'\n'}
						{'\n'}본 약관은 회원(본 약관에 동의한 자, 이하 ‘회원’)이 리프(Leap) 서비스(이하 ‘회사 서비스’라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 
						책임사항을 규정함을 목적으로 합니다.{'\n'}
						{'\n'}
						{'\n'}
						제 2 조 (이용약관의 효력 및 변경){'\n'}
